...
class Ui_MainWindow(QObject):
    ...
    def setupUi(self, MainWindow):
        ...
        self.spinBoxPixTime.setValue(474)
        ...
        self.doubleSpinMCP.setMaximum(750)
        ...
        #self.view.setGeometry(QtCore.QRect(20, 2, imageSizeUIx, imageSizeUIy))
        #self.cam.setObjectName("cam")
        
        
        #self.cam.scene = QtWidgets.QGraphicsScene(self.centralWidget)
        #self.cam.show()
        #self.scene.setGeometry(QtCore.QRect(20, 20, 521, 281))
        ...
        self.widget = QtWidgets.QWidget(self.centralWidget)
        self.widget.setGeometry(QtCore.QRect(20, 2, imageSizeUIx, imageSizeUIy))
        self.imv = pg.ImageView()#ImageView() 
        self.layout = QGridLayout() 

        self.widget.setLayout(self.layout)
        self.layout.addWidget(self.graphicsVideoL)#, 1, 0)
        
        self.layout.addWidget(self.imv)#, 0, 1, 3, 1)
        #imv.setImage(data, xvals=np.linspace(1., 3., data.shape[0])) 
        self.imv.ui.histogram.hide()
        self.imv.ui.roiBtn.hide()
        self.imv.ui.menuBtn.hide()
        self.imv.setPredefinedGradient('flame')
        self.imv.show()
        """
    #\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
    #slots
    ...
    def setImage(self, pixMap):
        #print(time.time() - self.t1, 'time upim')
        """
        ...
        convertToQtFormat = QtGui.QImage(image.data, w, h, bytesPerLine, QtGui.QImage.Format_Grayscale8)
        p = convertToQtFormat.scaled(imageSizeUIx, imageSizeUIy)
        ...
        #self.cam.scene.addItem(p)
        #self.cam.setScene(self.cam.scene)
        #_view = self.imv.getView()
        #_view_box = _view.getViewBox()
        #_state = _view_box.getState()
        
        #self.imv.setImage(image.T, autoLevels = True, autoRange=False,autoHistogramRange=False)
        #, levels=[1, 256])
        
        #, levels=[3, 6])#, xvals=np.linspace(1., 3., image.shape[0]))
        #self.imv.adjustSize()
        #self.imv.show()
