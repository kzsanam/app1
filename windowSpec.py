...
class Ui_WindowSpec(QObject):
    ...
    def setupUi(self, MainWindow):
        ...
        self.checkBoxInitCam.setObjectName("checkBoxInitCam")
        ...
        self.labelSpecMaxText = QtWidgets.QLabel(self.groupBoxSpec)
        self.labelSpecMaxText.setGeometry(QtCore.QRect(140, 40, 70, 20))
        self.labelSpecMaxText.setObjectName("labelSpecMaxText")
        self.labelSpecMaxText.setText("maximum")    
       
        self.labelSpecMaxValue = QtWidgets.QLabel(self.groupBoxSpec)
        self.labelSpecMaxValue.setGeometry(QtCore.QRect(140, 60, 70, 20))
        self.labelSpecMaxValue.setObjectName("labelSpecMaxValue")
        self.labelSpecMaxValue.setText("460")  
        self.labelSpecMaxValue.setFont(QFont('Arial', 15)) 
        self.labelSpecMaxValue.setStyleSheet('color: green')
        
        self.labelPhotonNumberText = QtWidgets.QLabel(self.groupBoxSpec)
        self.labelPhotonNumberText.setGeometry(QtCore.QRect(210, 40, 90, 20))
        self.labelPhotonNumberText.setObjectName("labelPhotonNumberText")
        self.labelPhotonNumberText.setText("ph num")  
        
        self.labelPhotonNumberValue = QtWidgets.QLabel(self.groupBoxSpec)
        self.labelPhotonNumberValue.setGeometry(QtCore.QRect(210, 60, 90, 20))
        self.labelPhotonNumberValue.setObjectName("labelPhotonNumberValue")
        self.labelPhotonNumberValue.setText("460")  
        self.labelPhotonNumberValue.setFont(QFont('Arial', 15)) 
        self.labelPhotonNumberValue.setStyleSheet('color: green')
    ...
    def setSpectrum(self, spec):
        ...
        self.labelSpecMaxValue.setText(str(round(spectrum[1][np.argmax(spectrum[0])], 2)))
        #self.graphicsSpectrum.plot(theorSpectrum[1], theorSpectrum[0], pen = pen,clear=False)
